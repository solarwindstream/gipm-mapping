...
def FFT_Hann_20(cluster_ULF_csv, str_centre):
    ...
    #energy correction for hann power loss
    ...
    print('Power in 7-100mHz Pc3-4 Band, Twenty Minute Interval, Hann Window, Parallel:', twentyminute_para_int_power, 'nT^2')
    print('Power in 7-100mHz Pc3-4 Band, Twenty Minute Interval, Hann Window, Perpendicular:', twentyminute_perp_int_power, 'nT^2')
