...
def gipm_loc_transform(only_full_windows, df_a, GIPM_X_Vecs, GIPM_Y_Vecs, GIPM_Z_Vecs, FAC_coeffs, GIPM_X_Vecs_med, GIPM_Y_Vecs_med, GIPM_Z_Vecs_med, FAC_coeffs_med):
    ...
    Cluster_dt_loc = pd.DataFrame({'datetime':only_full_windows, 'GSE X (mean)': Cluster_GSE_X, 'GSE Y (mean)': Cluster_GSE_Y, 'GSE Z (mean)': Cluster_GSE_Z, 'GIPM X (OMNI mean)': Cluster_GIPM_X, 'GIPM Y (OMNI mean)': Cluster_GIPM_Y, 'GIPM Z (OMNI mean)': Cluster_GIPM_Z, 'GIPM X (OMNI median)': Cluster_GIPM_X_med, 'GIPM Y (OMNI median)': Cluster_GIPM_Y_med, 'GIPM Z (OMNI median)': Cluster_GIPM_Z_med})
