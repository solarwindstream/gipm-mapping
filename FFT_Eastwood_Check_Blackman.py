...
def FFT_blackman_20(cluster_ULF_csv, str_centre):
    ...
    twenty_min_blackman = np.blackman(len(x_20mins_perp_1))
    x_20mins_perp_1 = x_20mins_perp_1*twenty_min_blackman
    
    time_ser = (np.arange(len(x_20mins_perp_1)))*sample_rate 
    ...
    print('Power in 7-100mHz Pc3-4 Band, Twenty Minute Interval, Blackman Window, Parallel:', twentyminute_para_int_power, 'nT^2')
    print('Power in 7-100mHz Pc3-4 Band, Twenty Minute Interval, Blackman Window, Perpendicular:', twentyminute_perp_int_power, 'nT^2')
    ...
    ax1.set_title('20 Minute Interval, Blackman Window')
    ...
    ax2.set_title('10 Minute Interval, Blackman Window')
    ...
    ax3.set_title('4 Minute Interval, Blackman Window')
    ...
    ax4.set_title('2 Minute Interval, Blackman Window')
